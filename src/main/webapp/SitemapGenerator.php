...
class SitemapGenerator {
     ...
     * @access public
     */
    public function _writeFile($content, $filePath, $fileName) {
     ...
     * @access public
     */
    public function _writeGZipFile($content, $filePath, $fileName) {
