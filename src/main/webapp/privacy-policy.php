...
<head>
    ...
    <title><?php echo $siteObject->getTermsMenuArray()['ariaLabel'][1]; ?></title>
</head>
<?php
    $_SESSION['strMainMenu'] = 'Rack Track Privacy Policy';
?>
<body>
    <?php include($siteTags.'header.php');?>
    <?php include($siteTags.'main-start.php');?>
    <?php includeWithVariables($siteTitle.'page-title.php', array('h1' => 'Privacy Policy', 'h2' => 'for Rack Track, LLC')); ?>
    <div class="page-layout py-5">
        <div class="row row-cols-1 g-4">
            <div class="col px-5">
            <p>At Rack Track, accessible from https://ecautopilot.com, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Rack Track and how we use it.</p>

            <p>If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us.</p>

            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in Rack Track.</p>
            <!--<p>This policy is not applicable to any information collected offline or via channels other than this website. Our Privacy Policy was created with the help of the <a href="https://www.privacypolicygenerator.info">Privacy Policy Generator</a> and the <a href="https://www.generateprivacypolicy.com">Generate Privacy Policy Generator</a>.</p>-->
