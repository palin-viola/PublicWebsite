...
class RackTrackSite
{
    public $favIcon = "images/favicon.png";
    public $title = "Rack Track - Home";
    public $description = "Rack Track is an Inventory Management system that enables the ability to get real time reports on any deployed device, anywhere.";
    public $keywords = "Inventory Management system,cloud-based SaaS product,  geolocation/GPS location, Fast Global Search";
    public $themeColor = "#df3311";
    public $fontImport = "https://fonts.googleapis.com/css2?family=Mukta:wght@400;500;600;700;800&display=swap";
    public $CSSLib = "css/main.min.css";
    public $DeferJSLib = "js/main-bundle.min.js";

    public $companyName = "Rack Track, Inc.";
    public $companyAddress = "6709 Ridge Rd. Port Richey, FL 34668";
    public $companyAddressLine1 = "6709 Ridge Rd.";
    public $companyAddressLine2 = "Port Richey, FL 34668";
    public $companyEmail = "corporate@rack-track.com";
    public $companyTel = "(833) 722-5875";
    public $companySupportEmail = "support@rack-track.com";
    public $companySupportTel = "(833) RACK-TRK";
    public $companySalesTel = "(707) RACK-TRK";
    public $companySalesTel2 = "(707) 722-5875";
    public $companySalesTel3 = "(813)-345-2700";
    public $login = "https://aws.rack-track.com/a/login.do";
    public $signup = "https://aws.rack-track.com/a/signup.do";

    //footer lib
    public $copyrightYearStart = "2022";
    public $facebook = "https://www.facebook.com/RackTrack";
    public $twitter = "https://twitter.com/RackTrack";
    ...
    public $aboutPage = array(
        'text' => array( 0 => "About"),
        'ariaLabel' => array( 0 => "Rack Track Home Page"),
        'href' => array( 0 => "index.php")
    );

    public $featuresPage = array(
    ...
    public $featuresMenuArray = array(
    ...
    public $featuresGlobalSearchMenuArray = array(
    ...
    public $featuresRegionalMappingMenuArray = array(
    ...
    public $featuresInventoryManagementMenuArray = array(
    ...
    public $featuresSiteManagementMenuArray = array(
    ...
    public $featuresDashboardMenuArray = array(
    ...
    public $featuresCustomMenuArray = array(
    ...
    public $termsMenuArray = array(
        ...
        'href' => array( 0 => "terms-and-conditions.php", 1 => "privacy-policy.php", 2 => "GDPR.php", 3 => "sitemap.php")
    );

    public $svgIconsArray = array(
    ...
    public function getSvgIconsArray()
    {
    ...
    public function getFeaturesMenuArray()
    {
        return $this->featuresMenuArray;
    }

    public function getFeaturesGlobalSearchMenuArray()
    {
        return $this->featuresGlobalSearchMenuArray;
    }

    public function getFeaturesRegionalMappingMenuArray()
    {
        return $this->featuresRegionalMappingMenuArray;
    }

    public function getFeaturesInventoryManagementMenuArray()
    {
        return $this->featuresInventoryManagementMenuArray;
    }

    public function getFeaturesSiteManagementMenuArray()
    {
        return $this->featuresSiteManagementMenuArray;
    }

    public function getFeaturesDashboardMenuArray()
    {
        return $this->featuresDashboardMenuArray;
    }

    public function getFeaturesCustomMenuArray()
    {
        return $this->featuresCustomMenuArray;
    }

    public function getTermsMenuArray()
    {
    ...
    public function getCopyrightYearStart()
    {
    ...
    public function getCompanySupportTel()
    {
    ...
    public function getCompanySupportEmail()
    {
    ...
    public function getCompanySalesTel()
    {
    ...
    public function getCompanySalesTel2()
    {
    ...
    public function getCompanySalesTel3()
    {
